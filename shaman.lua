BIS_LIST_SHAMAN = {
    ...
    ["Restoration"] = {
        BIS = {
            ...
            { slot = "MainHandSlot", itemID = 50734, source = "The Lich King 25HC" }, -- Royal Scepter of Terenas II
            { slot = "MainHand0Slot", itemID = 46017, source = "Ulduar Quest Line" }, -- Val'anyr, Hammer of Ancient Kings
            { slot = "SecondaryHandSlot", itemID = 50616, source = "Marrowgar 25HC" }, -- Bulwark of Smouldering Steel
            { slot = "RangedSlot", itemID = 50464, source = "Vendor Frost Emblem" } -- Totem of the Surging Sea
        },
        PreBIS = {
            { slot = "HeadSlot", itemID = 51192, source = "Vendor Normal Mark" }, -- Sanctified Frost Witch's Faceguard
            { slot = "NeckSlot", itemID = 50182, source = "Blood Queen Lana'thel 25 or Action House" }, -- Blood Queen's Crimson Choker
            { slot = "ShoulderSlot", itemID = 51194, source = "Vendor Normal Mark" }, -- Sanctified Frost Witch's Spaulders
            { slot = "BackSlot", itemID = 53489, source = "Halion 25" }, -- Cloak of Burning Dusk
            { slot = "ChestSlot", itemID = 51190, source = "Vendor Normal Mark" }, -- Sanctified Frost Witch's Tunic
            { slot = "WristSlot", itemID = 50030, source = "Rotface 25" }, -- Bloodsunder's Bracers
            ...
            { slot = "MainHandSlot", itemID = 50428, source = "The Lich King 25" }, -- Royal Scepter of Terenas II
            { slot = "MainHand0Slot", itemID = 50685, source = "Rotface 25HC" }, -- Trauma
            { slot = "SecondaryHandSlot", itemID = 49976, source = "Lord Marrowgar 25" }, -- Bulwark of Smouldering Steel
            { slot = "RangedSlot", itemID = 47665, source = "Vendor Triumph Emblem" } -- Totem of Calming Tides
        }
    },
